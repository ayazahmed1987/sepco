...
// });
    ...
    Route::middleware(['auth:admin'])->group(function () {
        ...
        Route::prefix('cms')->as('cms.')->group(function () {
			...
			Route::prefix('settings')->controller(WebsiteSettingController::class)->as('settings.')->group(function () {
				Route::get('/edit', 'edit')->name('edit');
                Route::post('/edit', 'update')->name('update');
            });
            Route::prefix('customposts')->controller(CustomPostController::class)->as('customposts.')->group(function () {
                Route::get('/', 'index')->name('index');
                Route::get('/create', 'create')->name('create');
                Route::post('/store', 'store')->name('store');
                Route::get('/edit/{custompost}', 'edit')->name('edit');
                Route::get('/fields-render', 'fieldsRender')->name('fields-render');
                Route::put('/update/{custompost}', 'update')->name('update');
                Route::delete('/delete/{custompost}', 'destroy')->name('destroy');
                Route::post('/toggle-status', 'toggleStatus')->name('toggle-status');
            });
			Route::prefix('custompostdata')->controller(CustomPostDataController::class)->as('custompostdata.')->group(function () {
                Route::get('/{custompostid}', 'index')->name('index');
                Route::get('/create/{custompostid}', 'create')->name('create');
                Route::post('/store', 'store')->name('store');
                Route::get('/edit/{custompostdata}', 'edit')->name('edit');
                Route::get('/fields-render', 'fieldsRender')->name('fields-render');
                Route::put('/update/{custompostdata}', 'update')->name('update');
                Route::delete('/delete/{custompostdata}', 'destroy')->name('destroy');
				Route::get('/media-remove/{custompostdata}/{field}', 'mediaRemove')->name('media-remove');
				Route::get('/specific-media-remove/{custompostdata}/{mediaFile}', 'specificMediaRemove')->name('specific-media-remove');
                Route::post('/toggle-status', 'toggleStatus')->name('toggle-status');
            });
