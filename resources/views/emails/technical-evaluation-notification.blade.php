...
<head>
    <meta charset="UTF-8">
    <title>Intimation for Financial Bid Opening - PSPC</title>
    ...
    <div class="email-wrapper">
        <div class="pspc-card">
            ...
            <div class="pspc-header">
                ...
                <p class="mb-0">Intimation for Financial Bid Opening</p>
            </div>
            ...
            <div class="p-4" style="padding: 20px;">
                ...
                <p class="text-dark mb-2">
                    <strong>Subject:</strong> Intimation for Financial Bid Opening (Tender No.
                    {{ $evaluation->tender->ref_no }})
                </p>

                <p class="text-dark mb-3">
                    This is to inform you that the financial bid opening of <strong>Tender No.
                        {{ $evaluation->tender->ref_no }}</strong> is due today.<br>
                    Please ensure the opening of financial bid as per scheduled time.
                </p>
