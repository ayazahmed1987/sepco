...
@section('content')
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="Search tenders..." id="search"
    ...
    <div class="container ">
        <div class="container-custom" id="tenders-container">
            @include('frontend.tenders.partials.tenders', ['tenders' => $tenders])
        </div>
    </div>
@endsection
@push('custom-css')
...
@push('custom-js')
    <script>
        function fetchTenders(url = "{{ route('website.tender.index') }}") {
    ...
    <script>
        const attachmentRoute = @json(route('website.tender.getAttachments', ['id' => '__ID__']));
        $(document).ready(function() {
            $(document).on('click', '.view-detail-btn', function() {
                const tenderId = $(this).data('id');
                const url = attachmentRoute.replace('__ID__', tenderId);
                $.get(url, function(response) {
                    $('#tenderDetailModal').remove();
