        ...
        <div class="tender-card p-4">
            <div class="row align-items-center">
                ...
                <div class="col">
                    ...
                    <div class="bid-evaluation-badge">Final Evaluation</div>
                ...
                <div class="col-auto">
                    <a href="{{ asset(Storage::url($final_evaluation->file)) }}" class="view-detail-btn">
                        Download Attachment
                    </a>
                </div>
            </div>
                ...
                <div class="row bg--ground p-2 rounded-3">
                    <div class="col-md-6">
                        <div class="publish-info">
                            ...
                            Published On:
                            {{ \Carbon\Carbon::parse($final_evaluation->published_date)->format('d-M-Y') }}
                        </div>
                    </div>
                    <div class="col-md-6 text-md-end">
                        <div class="publish-info">
                            ...
                            Published
                            {{ \Carbon\Carbon::parse($final_evaluation->published_date)->diffForHumans() }}
                        </div>
                    </div>
                </div>
            </div>
