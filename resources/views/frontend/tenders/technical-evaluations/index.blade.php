...
@section('content')
    ...
    <div class="container ">
        <div class="container-custom" id="tenders-container">
            @include('frontend.tenders.technical-evaluations.partials.technical-evaluations', [
...
@push('custom-css')
    <style>
        ...
        .tender-icon {
            background: linear-gradient(135deg, #556B2F, #3B4B3B);
            width: 145px;
...
@push('custom-js')
    <script>
        function fetchTenders(url = "{{ route('website.technical-evaluations.index') }}") {
