            ...
            <div class="col-md-12">
                <div class="card-header bg-white py-3">
                    <form id="searchForm" class="row align-items-end">
                        ...
                        {{-- Start Date --}}
                        <div class="col-md-4 mb-2">
                            <label for="start_date">Published Date (Start)</label>
                        ...
                        {{-- End Date --}}
                        <div class="col-md-4 mb-2">
                            <label for="end_date">Published Date (End)</label>
                        ...
                        {{-- Opening Date --}}
                        <div class="col-md-4 mb-2">
                            <label for="opening_date">Opening Date (Start)</label>
                            <input type="date" name="opening_date" id="opening_date" class="form-control bg-light"
                                value="{{ request('opening_date') }}">
                        </div>

                        {{-- Opening Date END --}}
                        <div class="col-md-4 mb-2">
                            <label for="opening_date">Opening Date (End)</label>
                            <input type="date" name="opening_date_end" id="opening_date_end"
                                class="form-control bg-light" value="{{ request('opening_date') }}">
                        </div>

                        {{-- Tender Person --}}
                        <div class="col-md-4">
                            <label for="tender_person" class="fw-bold">Tender Persons</label>
                            <select class="form-control bg-light" id="tender_person" name="tender_person">
                ...
                <div id="tender-table-container">
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3 flex-wrap">
                        <div class="mb-2 text-muted">
                            Showing <strong>{{ $tenders->firstItem() }}</strong> to
                            <strong>{{ $tenders->lastItem() }}</strong> of
    ...
    <script>
        $(document).ready(function() {
            ...
            function loadTenders(page) {
                ...
                let url = '{{ route('manager.reporting.tenders') }}?page=' + page + '&' + searchParams;
                $.ajax({
                    url: url,
                    type: 'GET',
