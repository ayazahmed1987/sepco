...
@section('content')
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Final Evaluations List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/manager') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Final Evaluations List</li>
                    </ol>
                </div>
            </div>
            ...
            @can('tender-person-create')
                <div class="col-md-12 text-right">
                    <a href="{{ route('manager.final-evaluations.create') }}" class="btn btn-dark mb-3">
                        Add new Final Evaluation
                    </a>
                </div>
            @endcan
            <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <div class="input-group">
                                ...
                                <input type="text" name="search" class="form-control border-left-0 bg-light"
                                    placeholder="Search by Ref No" value="{{ request('search') }}">
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div id="final-evaluation-table-container">
                            ...
                            @forelse  ($final_evaluations as $key => $final_evaluation)
                                <tr>
                                    ...
                                    <td><a class="btn btn-dark"
                                            href="{{ asset(Storage::url($final_evaluation->file)) }}"><i
...
@push('specific_js')
    <script>
        function deleteFunction(key) {
            ...
            var form = $("#deleteFinalEvaluationForm" + key);
            Swal.fire({
                title: "Are you sure, you want to delete this Final Evaluation?",
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: "Deleted!",
                        text: "Final Evaluation has been deleted.",
                        icon: "success"
                    });
                }
            });
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#final-evaluation-table-container .pagination a', function(e) {
                e.preventDefault();
            ...
            function loadTenders(page) {
                ...
                let url = '{{ route('manager.final-evaluations.index') }}?page=' + page + '&' + searchParams;
                $.ajax({
                    url: url,
                    type: 'GET',
                    success: function(response) {
                        $('#final-evaluation-table-container').html(response);
