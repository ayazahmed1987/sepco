...
@section('content')
    <section class="content mt-3">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Technical Evaluations List</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ url('/manager') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Technical Evaluations List</li>
                    </ol>
                </div>
            </div>
            ...
            @can('tender-person-create')
                <div class="col-md-12 text-right">
                    <a href="{{ route('manager.technical-evaluations.create') }}" class="btn btn-dark mb-3">
                        Add new Technical Evaluation
                    </a>
                </div>
            @endcan
            <div class="col-md-12">
                ...
                <div id="technical-evaluation-table-container">
                            ...
                            @forelse  ($technical_evaluations as $key => $technical_evaluation)
                                <tr>
                                    ...
                                    <td><a class="btn btn-dark"
                                            href="{{ asset(Storage::url($technical_evaluation->file)) }}"><i
...
@push('specific_js')
    <script>
        function deleteFunction(key) {
            ...
            var form = $("#deleteTechnicalEvaluationForm" + key);
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Swal.fire({
                        title: "Deleted!",
                        text: "Technical Evaluation has been deleted.",
                        icon: "success"
                    });
                }
            });
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#technical-evaluation-table-container .pagination a', function(e) {
                e.preventDefault();
            ...
            function loadTenders(page) {
                ...
                let url = '{{ route('manager.technical-evaluations.index') }}?page=' + page + '&' + searchParams;
                $.ajax({
                    url: url,
                    type: 'GET',
                    success: function(response) {
                        $('#technical-evaluation-table-container').html(response);
